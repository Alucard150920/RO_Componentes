...
if (!$conexion->connect_error) {
    $sql = "SELECT * FROM productos WHERE categoria = 'Periféricos'";
...
<head>
    ...
    <title>Periféricos - RO Componentes</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 hero-content">
                    <h2 class="hero-title fade-in text-cente">🖱️ Periféricos</h2>
                </div>
                <div class="col-lg-3 text-center">
                    <div class="hero-image fade-in">
                        <i class="fas fa-mouse" style="font-size: 6rem; opacity: 0.3;"></i>
                    </div>
                </div>
            </div>
        </div>
