...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $verificarCorreo = $conexion->prepare("SELECT codUsu FROM usuarios WHERE emaUsu = ?");
    ...
    if ($verificarCorreo->num_rows > 0) {
        ...
        $sql = "INSERT INTO usuarios (nomUsu, emaUsu, pasUsu) VALUES (?, ?, ?)";
...
<head>
    ...
    <title>Registro - RO Componentes</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 hero-content">
                    <h2 class="hero-title fade-in text-cente">📝 Registro del Usuario</h2>
                </div>
                <div class="col-lg-3 text-center">
                    <div class="hero-image fade-in">
                        <i class="fas fa-list" style="font-size: 6rem; opacity: 0.3;"></i>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5">
                    <div class="card card-modern fade-in">
                        <div class="card-body card-body-modern">
                            <h2 class="section-title text-center mb-4">📝 Registro</h2>
                            ...
                            <form method="POST" action="">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control input-modern" placeholder="Juan Pérez" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn-professional w-100 mt-3">Crear cuenta</button>
                            </form>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 RO Componentes. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
