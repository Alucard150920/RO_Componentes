...
if (!$conexion->connect_error) {
    $sql = "SELECT * FROM productos WHERE categoria = 'Componentes PC'";
...
<head>
    ...
    <title>Componentes PC - RO Componentes</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    <h2 class="hero-title fade-in text-cente">💻 Componentes PC</h2>
                </div>
                <div class="col-lg-6 text-center">
                    <div class="hero-image fade-in">
                        <i class="fas fa-desktop" style="font-size: 7rem; opacity: 0.3;"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.btn-agregar-carrito').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    agregarAlCarrito(id, nombre, precio, stock, this);
                });
            });
        });
        // Animation on scroll
